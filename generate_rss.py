...
SITE_URL = "https://opera.opengeos.org"
SITE_TITLE = "NASA OPERA Blog"
SITE_SUBTITLE = "Updates, tutorials, and notes on NASA OPERA data products."
AUTHOR = {"name": "NASA OPERA", "email": "noreply@example.com"}
LANGUAGE = "en"
