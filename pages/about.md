...
This effort is led by **Dr. Qiusheng Wu** at the University of Tennessee, an established open-source geospatial software contributor and the creator and maintainer of widely adopted Python packages including **Geemap**, **Leafmap**, **SamGeo**, and **GeoAI**, as well as numerous QGIS plugins. The period of performance is **February 1, 2026 – September 26, 2027**. All materials are released publicly on GitHub to support adoption, reproducibility, and capacity building.
